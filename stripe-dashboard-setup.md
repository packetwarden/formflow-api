...
3. Forgetting to include critical lifecycle events (`customer.deleted`, `customer.subscription.deleted|paused|resumed`, `invoice.created`, `invoice.payment_action_required`, `invoice.finalization_failed`).
