...
```sql
SELECT
  has_table_privilege('anon', 'public.form_submissions', 'INSERT') AS anon_insert_form_submissions,
  has_table_privilege('authenticated', 'public.form_submissions', 'INSERT') AS authenticated_insert_form_submissions,
  has_function_privilege('anon', 'public.submit_form(uuid,jsonb,uuid,inet,text,text,timestamptz,uuid)', 'EXECUTE') AS anon_submit_form_execute,
  has_function_privilege('authenticated', 'public.submit_form(uuid,jsonb,uuid,inet,text,text,timestamptz,uuid)', 'EXECUTE') AS authenticated_submit_form_execute,
  has_function_privilege('service_role', 'public.submit_form(uuid,jsonb,uuid,inet,text,text,timestamptz,uuid)', 'EXECUTE') AS service_role_submit_form_execute;
```
